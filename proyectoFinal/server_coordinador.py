...
from proyectoFinal.classes.Reloj import Reloj
from proyectoFinal.procedures.timeServ import *
from proyectoFinal.procedures.coordinador import *
...
def saveSumNumbers():
	...
	if file and allowed_file(file.filename):
		...
		frecuencias = calculaFrecuencias(listaNums)

		print("Hará hilo...")
		acks = sendResultToOtherServer(ip_origen, numeroServer, frecuencias, nombreEquipoOrigen, prioridad_equipos)
		...
		guardado = guardaEnBd( ip_origen, numeroServer, frecuencias, relojes[0], nombreEquipoOrigen, dbName=database)
...
if __name__ == "__main__":
	...
	for a in range(0, len(resultados)):
		resultados[a] = { 'idJugador': a, 'frecuencias':{} }
